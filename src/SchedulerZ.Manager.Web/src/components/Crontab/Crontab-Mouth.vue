  ...
  <a-form-model size="small">
    ...
    <a-form-model-item>
      <a-radio v-model="radioValue" :label="2">
        周期从
        <a-input v-model.number="cycle01" :min="1" :max="12" /> -
        <a-input v-model.number="cycle02" :min="1" :max="12" /> 月
      </a-radio>
    </a-form-model-item>
    ...
    <a-form-model-item>
      <a-radio v-model="radioValue" :label="3">
        从
        <a-input v-model.number="average01" :min="1" :max="12" /> 月开始，每
        <a-input v-model.number="average02" :min="1" :max="12" /> 月月执行一次
      </a-radio>
    </a-form-model-item>
