  ...
  <a-form-model size="small">
    ...
    <a-form-model-item>
      <a-radio v-model="radioValue" :label="2">
        ...
        <a-input v-model.number="cycle02" :min="0" :max="60" /> 分钟
      </a-radio>
    </a-form-model-item>
    ...
    <a-form-model-item>
      <a-radio v-model="radioValue" :label="3">
        从
        <a-input v-model.number="average01" :min="0" :max="60" /> 分钟开始，每
        <a-input v-model.number="average02" :min="0" :max="60" /> 分钟执行一次
      </a-radio>
    </a-form-model-item>
